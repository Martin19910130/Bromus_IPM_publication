...
VR_all <- grid.arrange(VR_amb, VR_fut, VR_mow, VR_gra,
                       ncol = 2, nrow = 2, top = textGrob("\u0394 vital rates between treatments", gp=gpar(fontsize=15)), 
...
Sensitivity_all <- grid.arrange(sensitivity_amb, sensitivity_fut, sensitivity_mow, sensitivity_gra,
                                ncol = 2, nrow = 2, top = textGrob("Sensitivity of \u03BB to vital rates", gp=gpar(fontsize=15)),
                                layout_matrix = rbind(c(1, 2), c(3, 4)), 
...
LTRE_all <- grid.arrange(LTRE_amb, LTRE_fut, LTRE_mow, LTRE_gra,
                         ncol = 2, nrow = 2, 
                         top = textGrob("Life table response experiment", gp=gpar(fontsize=15)), #left = "\u0394 \u03BB caused by vital rates",
                         layout_matrix = rbind(c(1, 2), c(3, 4)), 
